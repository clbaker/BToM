function varargout = expt_bel_des_inf2(varargin)
% EXPT_BEL_DES_INF2 M-file for expt_bel_des_inf2.fig
%      EXPT_BEL_DES_INF2, by itself, creates a new EXPT_BEL_DES_INF2 or raises the existing
%      singleton*.
%
%      H = EXPT_BEL_DES_INF2 returns the handle to a new EXPT_BEL_DES_INF2 or the handle to
%      the existing singleton*.
%
%      EXPT_BEL_DES_INF2('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in EXPT_BEL_DES_INF2.M with the given input arguments.
%
%      EXPT_BEL_DES_INF2('Property','Value',...) creates a new EXPT_BEL_DES_INF2 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before expt_bel_des_inf2_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to expt_bel_des_inf2_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help expt_bel_des_inf2

% Last Modified by GUIDE v2.5 03-Feb-2017 11:27:41

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @expt_bel_des_inf2_OpeningFcn, ...
                   'gui_OutputFcn',  @expt_bel_des_inf2_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before expt_bel_des_inf2 is made visible.
function expt_bel_des_inf2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to expt_bel_des_inf2 (see VARARGIN)
...
set(handles.text2,'string',sprintf('2. How much does %s like each truck?',pronouns{1}));
...
set(handles.text36,'string',sprintf('1. At the beginning of the video, when %s was in the location shown below, what did %s think was in the spot marked with "?":',pronouns{1},pronouns{2}));
...
% UIWAIT makes expt_bel_des_inf2 wait for user response (see UIRESUME)
uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = expt_bel_des_inf2_OutputFcn(hObject, eventdata, handles) 
