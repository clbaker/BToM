...
% beta=2.5
[val,btom.beta_ind] = ...
    max(fcorr(reshape(btom.belief_model(:,incl,:),[3*n_incl,20]), ...
           m2v(people.bel_inf_mean_norm(:,incl))) ...
        + fcorr(reshape(btom.desire_model(:,incl,:),[3*n_incl,20]), ...
             m2v(people.des_inf_mean(:,incl))));

[val,truebelief.beta_ind] = ...
    max(fcorr(reshape(truebelief.belief_model(:,incl,:),[3*n_incl,20]), ...
           m2v(people.bel_inf_mean_norm(:,incl))) ...
        + fcorr(reshape(truebelief.desire_model(:,incl,:),[3*n_incl,20]), ...
             m2v(people.des_inf_mean(:,incl))));

[val,nocost.beta_ind] = ...
    max(fcorr(reshape(nocost.belief_model(:,incl,:),[3*n_incl,20]), ...
           m2v(people.bel_inf_mean_norm(:,incl))) ...
        + fcorr(reshape(nocost.desire_model(:,incl,:),[3*n_incl,20]), ...
             m2v(people.des_inf_mean(:,incl))));
...
rbg_check = partialcorr(m2v(belief_people),m2v(belief_model),m2v(belief_model_group_reg));
...
rbi_check = partialcorr(m2v(belief_people),m2v(belief_model_group_reg),m2v(belief_model));
